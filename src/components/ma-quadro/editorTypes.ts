...
export type MAQuadroSelectionState = {
  ...
  imageFilters: MAQuadroImageFilterState
  cropHorizontal: number
  cropVertical: number
}

export type MAQuadroExportOptions = {
  format: MAQuadroExportFormat
...
export type MAQuadroEditor = {
  ...
  saveState: MAQuadroSaveState

  project: MAQuadroProject | null
  projects: MAQuadroProject[]
  activePage: MAQuadroPage | null

  brand: MAQuadroBrand
  localFonts: MAQuadroStoredFont[]
  ...
  layers: MAQuadroLayerItem[]
  selection: MAQuadroSelectionState
  activePanel: MAQuadroPanelId
  ...
  createFromPreset: (
    preset: MAQuadroCanvasPreset
  ) => Promise<void>

  createCustomDesign: (
    values: MAQuadroNewDesignValues
  ) => Promise<void>
