    ...
    <header className="sticky top-0 z-[70] border-b border-white/10 bg-slate-950/95 text-white shadow-xl shadow-black/20 backdrop-blur-xl">
      <div className="mx-auto flex max-w-[1800px] items-center gap-3 px-2 py-2 sm:px-5">
        <button
          ...
          aria-label="Abrir as aulas do dia"
        >
        ...
        <nav className="grid min-w-0 flex-1 grid-cols-5 gap-1 rounded-2xl border border-white/10 bg-slate-900/80 p-1">
          {items.map(
            (
              item
            ) => {
              ...
              return (
                <button
                  ...
                  className={`min-w-0 rounded-xl px-1 py-2 text-center text-[0.68rem] font-black transition sm:px-3 sm:text-xs ${
                    active
