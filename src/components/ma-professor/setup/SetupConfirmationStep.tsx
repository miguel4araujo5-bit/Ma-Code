        ...
        <div className="mt-5 space-y-3">
          ...
          >
            ...
            <span>
              ...
              <span className="mt-1 block text-sm leading-6 text-slate-400">
                Os dados principais ficam guardados localmente. As cópias online são opcionais e cifradas neste dispositivo antes do envio. A MA-CODE não recebe a minha password pessoal nem guarda no servidor o material necessário para ler os dados. Posso ativar ou desativar a cópia automática em Segurança e recuperação e restaurar uma cópia através da minha conta.
              </span>
            </span>
          </label>
        </div>
