...
export const portfolioProjects: PortfolioProject[] = [
  {
    ...
    clientNeed:
      'A rádio escolar precisava de uma presença digital organizada, onde a comunidade pudesse encontrar programas, aceder ao arquivo e utilizar a plataforma de forma prática, sem depender de ficheiros dispersos ou publicações difíceis de consultar.',
    highlights: [
    ...
    businessValue: [
      ...
      'Base preparada para novos conteúdos',
    ],
  ...
  },
  {
    ...
    description:
      'Website profissional desenvolvido para modernizar a presença digital do salão Rosa Maria Cabeleireiros, em São Mamede de Infesta.\n\nO projeto combina apresentação dos serviços, marcação online, painel privado de administração, notificações, mapa/localização e otimização para telemóvel, permitindo ao salão receber pedidos de marcação de forma mais organizada.',
    clientNeed:
      'O salão precisava de uma presença online mais profissional e de uma forma simples de receber pedidos de marcação, consultar agenda, gerir horários e facilitar o contacto de clientes através do telemóvel.',
    highlights: [
    ...
    businessValue: [
      'Mais facilidade em receber marcações',
  ...
  },
  {
    ...
    description:
      'Reconstrução completa de uma presença digital antiga para uma loja online moderna, discreta e preparada para venda direta.\n\nO projeto inclui catálogo de produtos, carrinho, checkout, páginas legais, analytics, consentimento de cookies, assistente digital e área administrativa para gestão de encomendas.',
    clientNeed:
      'A marca precisava de uma loja online mais credível, organizada e preparada para vender, com uma navegação clara, experiência discreta, carrinho de compras, checkout estruturado e gestão interna das encomendas.',
    highlights: [
