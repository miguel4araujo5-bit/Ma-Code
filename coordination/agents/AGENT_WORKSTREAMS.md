...
|---|---|---|---|---|---|---|
| F101 | Ao carregar em “Copiar” no sumário, marcar imediatamente “Submetido no GIAE”, incluindo aulas futuras | `work/f101-copy-giae-submit` | `src/components/ma-professor/daily/dailyGIAEAuto.ts`; `tests/ma-professor/daily-giae-auto.test.mjs` | VALIDADO — a exceção de data futura deixou de bloquear o fluxo explícito de submissão após copiar; Build Check #1725 passou Conquistador, MA-Professor, MA-Quadro e build; PR #54 aguarda autorização explícita para merge | `0d17001e2b664db92a0078d47438248f71eea50e` | 2026-09-10 |
