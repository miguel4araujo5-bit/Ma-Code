...
| F103 | Corrigir destino de disciplina na importação de planificações: impedir que disciplinas antigas incorretas como AP sejam impostas e permitir editar/criar a disciplina lida do documento | `work/f103-planification-subject-destination` | `src/components/ma-professor/setup/ModulePlanificationImportPanel.tsx`; `src/components/ma-professor/setup/modulePlanificationImportRepository.ts`; testes específicos novos | EM CURSO — tornar a disciplina de destino editável e resolver/criar disciplina + associação às turmas atomicamente, preservando dados existentes | `e8a7d6e9814a802bd68c42e38d36de5945382fe3` | 2026-09-09 |
