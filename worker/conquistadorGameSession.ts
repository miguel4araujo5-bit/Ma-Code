...
import { chooseConquistadorBotCommand, getConquistadorBotActorId } from './conquistadorBotEngine';
...
const PRESENCE_WARNING_MS = 15000;
const BOT_ICON = '⚙';
...
export type ConquistadorGameSessionEnv = {
    CONQUISTADOR_GAME: DurableObjectNamespaceLike;
};
...
const getViewerActions = (
    ...
    if (
        ...
        actions.initialSeaRouteIds =
            game.getValidInitialSeaRouteIds();
    }

    if (
        isCurrentPlayer &&
        game?.phase === 'turn-roll'
    ) {
        actions.canRollDice = true;
    }

    if (
        isCurrentPlayer &&
        game?.phase === 'turn-actions'
    ) {
...
const createClientView = (
    ...
    const effectiveParticipants =
        getEffectiveParticipants(session);
...
export class ConquistadorGameSessionDurableObject {
    ...
    private async buildPresenceState(
        ...
        for (
            ...
            /*
             * IMPORTANTE:
             * O cronómetro NÃO começa no bootstrap.
             *
             * connectedAt = 0
             * lastSeenAt  = 0
             * takeoverAt  = 0
             *
             * Só o primeiro /state ou /command autenticado
             * deste jogador inicia a presença.
             */
            presence[
                participant.id
            ] = {
    ...
    private async authenticateHuman(
         ...
         * é aqui — e apenas aqui — que começa
         * o prazo de presença de 30 segundos.
         */
        if (
            !Number(
    ...
    private async handleBootstrap(
        ...
        /*
         * Neste momento os bots originais podem continuar
         * a ser agendados normalmente, mas humanos com
         * takeoverAt=0 NÃO entram no scheduler de presença.
         */
        await this
            .scheduleBot(
                game,
